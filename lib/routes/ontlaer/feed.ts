...
export const route: Route = {
    ...
    handler: async () => {
        const baseUrl = 'https://www.ontlaer.co.za';
        ...
        const items = posts.map((post: any) => {
            ...
            const authorName = post.publishedBylines?.map((b: any) => b.name).join(', ') || 'OntLaer';
        ...
        return {
            title: 'OntLaer',
            link: baseUrl,
            description: 'OntLaer – Redaksionele en nuus artikels',
            item: items,
        };
    },
};
