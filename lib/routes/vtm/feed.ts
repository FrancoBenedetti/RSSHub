...
export const route: Route = {
    ...
    radar: [
        {
            source: ['vtm.org.za/', 'vtm.org.za/nuus/', 'vtm.org.za/nuus/*'],
            target: '/',
        },
    ],
    name: 'Nuus / News Feed',
    ...
    handler: async () => {
        const feedUrl = 'https://vtm.org.za/feed/';
        ...
        return {
            title: feed.title ?? 'Voortrekkermonument',
            link: 'https://vtm.org.za',
            description: feed.description ?? 'Voortrekkermonument - Nuus, aankondigings en persverklarings',
            item: items,
        };
    },
};
